        ...
        <div class="col-md-6">
            ...
            <table class="table table-borderless">
                <tbody>
                    ...
                    <tr>
                        <td><span>Số học sinh</span></td>
                        <td><span>{{ $course->num_of_student }}</span></td>
                    </tr>
                    <tr>
                        <td><span class="text-nowrap">Trình độ giáo viên</span></td>
                        <td><span>{{ $teacher->teacherLevel->display_name }}</span></td>
                    </tr>
                    <tr>
                        <td><span class="text-nowrap">Số buổi / tuần</span></td>
                        <td><span>{{ $course->session_per_week }}</span></td>
                    </tr>
                    <tr>
                        <td><span class="text-nowrap"></span>Thời gian 1 buổi</td>
                    <td><span>{{ $course->time_per_session }}</span></td>
                    </tr>
                    <tr>
                        <td><span class="text-nowrap"></span>Lương theo tháng</td>
                        <td><span>{{ $course->tuition_per_month }}</span></td>
                    </tr>
                    <tr>
                        <td><span>Yêu cầu khác</span></td>
        ...
        <div class="col-md-6 border-left">
            ...
            <table class="table table-borderless">
                <tbody>
                    ...
                    <tr>
                        <td><span>Trương học</span></td>
                        <td><span>{{ $teacher->university }}</span></td>
                    </tr>
                    <tr>
                        <td><span>Chuyên ngành</span></td>
                        <td><span>{{ $teacher->speciality }}</span></td>
                    </tr>
                    <tr>
                        <td><span>Trình độ</span></td>
                        <td><span>{{ $teacher->teacherLevel->display_name }}</span></td>
                    </tr>
                    <tr>
                        <td><span class="text-nowrap">Thông tin thêm</span></td>
