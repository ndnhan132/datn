...
<i
        ...
        <ul class="app-notification dropdown-menu dropdown-menu-right">
            <li class="app-notification__title">You have 4 new notifications.
            </li>
...
<i
                        ...
                        <div>
                            <p class="app-notification__message">Lisa sent you a
                                mail</p>
...
<i
                        ...
                        <div>
                            <p class="app-notification__message">Transaction
                                complete</p>
...
<i
                            ...
                            <div>
                                <p class="app-notification__message">Lisa sent
                                    you a mail</p>
                                <p class="app-notification__meta">2 min ago</p>
                            </div>
                        </a>
...
<i
                            ...
                            <div>
                                <p class="app-notification__message">Mail server
                                    not working</p>
                                <p class="app-notification__meta">5 min ago</p>
                            </div>
                        </a>
